...
fun GradientBarChart(
        ...
        Column(modifier = modifier.height(maxHeight + labelHeight)) {
                        ...
                        Box(
                                ...
                                Row(
                                        ...
                                        horizontalArrangement =
                                                Arrangement.SpaceBetween, // Distribute evenly
                ...
                Row(
                        modifier =
                                Modifier.fillMaxWidth().height(labelHeight).padding(start = 32.dp),
...
fun LineChart(
        ...
        Row(modifier = modifier) {
                ...
                Column(
                        modifier =
                                Modifier.fillMaxHeight()
                                        .padding(end = 8.dp)
                                        .padding(bottom = 28.dp), // Align with X-axis labels height
                        verticalArrangement = Arrangement.SpaceBetween,
                        horizontalAlignment = Alignment.End
                ) {
                        for (i in 5 downTo 0) {
                ...
                // Chart Area + X Labels (Using Column to separate them)
                Column(modifier = Modifier.weight(1f).fillMaxHeight()) {

                        // Chart Canvas (Takes available space)
                        ...
                        Row(
                                modifier =
                                        Modifier.fillMaxWidth()
                                                .height(28.dp), // Fixed height for Year labels
                                horizontalArrangement = Arrangement.SpaceBetween,
                                verticalAlignment = Alignment.CenterVertically
                        ) {
                                xLabels.forEach { label ->
                                        val text =
                                                if (label is Int) "$monthName $label"
                                                else label.toString()
                                        Text(
                                                text = text,
                                                fontSize = 10.sp,
                ...
                if (transactions.isEmpty()) {
                        ...
                        groupedTransactions.forEach { (date, dailyTransactions) ->
                                ...
                                Card(
                                        ...
                                        Column {
                                                dailyTransactions.forEachIndexed {
                                                        index,
                                                        transaction ->
